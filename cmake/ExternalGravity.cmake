...
ExternalProject_Add(gravity
    ...
    DOWNLOAD_COMMAND git clone -b ACOPF --single-branch ${GRAVITY_DOWNLOAD_URL} && rm -fr ./Install/Gravity && mv Gravity ./Install/Gravity && cd ./Install/Gravity && mkdir build && cd build && cc=x86_64-w64-mingw32-gcc cxx=x86_64-w64-mingw32-g++ cmake -DMP=OFF .. && make gravity
    URL ${MP_DOWNLOAD_URL}
